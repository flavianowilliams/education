...
* Numa corda, somente pode existir números inteiros de comprimentos de onda.
...
.pull-right[
onde n é um número inteiro. Para outros valores de $\phi$, $y_m$ irá assumir valores entre $\sqrt{y_{m1}^2-y_{m2}^2}$ e $\sqrt{y_{m1}^2+y_{m2}^2}$.
...
.pull-right[
```{r, echo=FALSE, fig.align='center',fig.cap='Modos normais de vibração em uma corda esticada.',out.width="100%",fig.asp=1,fig.ncol=2}
...
.pull-right[
```{r, echo=FALSE, fig.align='center',fig.cap='Modos normais no tubo sonoro.',out.width="75%",fig.asp=1,fig.ncol=2}
  #knitr::include_graphics("img/onda-estacionaria.jpeg")
```
]
