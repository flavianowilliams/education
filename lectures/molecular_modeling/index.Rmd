...
output:
  xaringan::moon_reader:
    css: [css/defaults.css, css/my-theme.css, css/my-fonts.css]
...
A figura a seguir mostra a balburdia pilantreira de um condenado...

```{r, echo=FALSE, fig.cap = 'Página no GitHub',fig.align='center'}
