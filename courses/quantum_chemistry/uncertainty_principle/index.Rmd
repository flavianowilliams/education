...
.pull-right[
```{r, echo=FALSE, fig.align='center',fig.cap='Pacote de onda formado pela superposição de três ondas harmômicas.',out.width="100%",fig.asp=1,fig.ncol=2}
  knitr::include_graphics("img/superposicao-ondas-2.jpeg")
```
]
