...
y0=c(10417,10798,7842,8566,9157,9837)
...
.pull-right[
```{r, echo=FALSE, fig.align='center',fig.cap='Publicações envolvendo as palavras-chave "molecular dynamics" e "monte carlo".',out.width="58%"}
scielo=c(78,87,77,74,94,58)
webofscience=c(77,86,74,71,94,58)
bs=c(scielo,webofscience)
Base=c(rep("Scielo",6),rep("Web of Science",6))
...
.pull-left[
<div class="my-body"><span>Para determinar as frequências foi utilizado o cálculo Hartree-Fock com a base polarizada 6-31G*. Utilizamos o programa [NwChem](https://github.com/nwchemgit/nwchem) que já se encontra instalado e configurado no servidor. Das frequências calculadas, foram selecionadas aquelas que melhor representa o modo normal de vibração.</span></div>
]
.pull-right[
```{r, echo=FALSE, fig.align='center',out.width="60%"}
  knitr::include_graphics("img/GLYP.png")
