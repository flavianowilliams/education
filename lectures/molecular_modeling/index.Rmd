...
Alguns critérios foram adotados afim de tornar o programa inclusivo:
...
* Impressão de mensagens de aviso e erro a respeito das flags de entrada, contendo dicas e sugestões para a solução do problema;
...
* Ampliação da base de dados contendo os potenciais do campo de força.
