...
Para saber uma partícula deve ser tratada classicamente, o seu comprimento de onda de de Broglie deve ser muito menor que a distância média entre as partículas,
\begin{equation}
\lambda = \left(\frac{2\pi\hslash^2}{mk_BT}\right)^{1/2}.
\end{equation}

*"Como exemplo citamos a bola de beisebol, de acordo com o postulado de de Broglie o seu comprimento de onda é dado por $\lambda=\frac{h}{mv}$. Se a bola tiver a velocidade de $47,5\;m/s$, o seu comprimento de onda será de aproximadamente $9,3\times 10^{-33}\;cm$, que corresponde a um valor muito menor que o seu diâmetro."*
