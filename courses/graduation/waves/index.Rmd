...
.pull-right[
Isso vale para qualquer função de onda, inclusive para a onda resultante que surge do princípio da superposição.
```{r, echo=FALSE, fig.align='center',fig.cap='Representação do número complexo z no plano complexo.',out.width="90%",fig.asp=1,fig.ncol=2}
