...
```{r, echo=FALSE, message=FALSE, fig.align='center',fig.cap='Experimento da fenda dupla com baixa intensidade.',out.width="80%",fig.asp=0.5}
...
Foi defendido por Niels Bohr e Wener Heisenberg na interpretação de Copenhague
.pull-left[
...
.pull-right[
```{r, echo=FALSE, message=FALSE, fig.align='center',fig.cap='Experimento da fenda dupla com baixa intensidade.',out.width="100%",fig.asp=1}
