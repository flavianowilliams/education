...
Uma prática experimental que pode ser utilizada como exemplo da teoria da transição eletrônica abordada pelo modelo atômico de Bohr seria o teste da chama, onde é possível identificar o elemento químico a partir da cor emitida pela chama (veja a figura ao lado).
