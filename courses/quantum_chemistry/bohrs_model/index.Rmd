...
.pull-right[
  ...
  \begin{aligned}
    E\sim -\frac{1}{r}.
  \end{aligned}
* <font class="red">Se o elétron perdesse energia E devido a emissão de radiação, então o raio r da órbita diminuiria sucessivamente. Assim a colisão seria inevitável!!!;
