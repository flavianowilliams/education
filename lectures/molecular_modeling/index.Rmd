...
<span style="text-align: center;">Aquecimento global;</span>

```{r, echo=FALSE, fig.align='center',fig.cap='Fonte: BBC Brasil.',out.width="60%"}
  knitr::include_graphics("img/aquecimento-global.png")
```
]
.pull-right[
Surgimento de vírus e outras entitades patológicas;
```{r, echo=FALSE, fig.align='center',fig.cap='Fonte: BBC Brasil.',out.width="60%"}
  knitr::include_graphics("img/epidemia-aquecimento.png")
```
]
.pull-left[
...
.pull-right[
* Poluição de mares e rios (era do antropocentrismo).
```{r, echo=FALSE, fig.align='center',fig.cap='Fonte: BBC Brasil.',out.width="60%"}
  knitr::include_graphics("img/microplastico.jpg")
```
]
...
*No servidor diversos softwares (open source) foram instalados e configurados para o desenvolvimento do trabalho, como o gânglia para o monitoramento online.*

.pull-left[
```{r, echo=FALSE, fig.align='center',fig.cap='HICOLM.in contendo parâmetros da simulação',out.width="100%"}
...
.pull-left[
```{r, echo=FALSE, fig.align='center',fig.cap='Relatório da simulação.',out.width="70%"}
  knitr::include_graphics("img/report-1.png")
```
]
.pull-left[
```{r, echo=FALSE, fig.align='center',fig.cap='Série temporal em tempo real.',out.width="70%"}
  knitr::include_graphics("img/report-1.png")
```
]
