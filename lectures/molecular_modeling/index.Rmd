...
<div class="my-header"><span>Linhas de pesquisa</span></div>
...
.pull-left[
```{r, echo=FALSE, fig.align='center',fig.cap='Espectro vibracional da água líquida',out.width="90%"}
  knitr::include_graphics("img/infrared.png")
```
]
.pull-right[
```{r, echo=FALSE, fig.align='center',fig.cap='HICOLM.in contendo parâmetros da simulação',out.width="20%"}
...
.pull-right[
```{r, echo=FALSE, fig.align='center',fig.cap='Etapas de instalação do programa',out.width="60%"}
