...
\begin{aligned}
  E_n & = -\frac{KZe^2}{2r_n},\\\
      & = -\left(\frac{mKZ^2e^4}{2\hbar^2}\right)\frac{Z}{n^2},\\\
...
* <font class="red">De acordo com o modelo de Bohr, as órbitas estacionárias são comprovadas pela relação $r\sim n^2$ assumindo valores discretos com valores de n;</font>
* <font class="red">Cada órbita possui valor discreto de energia $E_n$, como mostra a equação acima.</font>
]
.pull-right[
...
my_data <- data.frame(n,t) %>%
  ...
  mutate(x=ifelse(n==0,myfuncx(3.5,0,t),x),y=ifelse(n==0,myfuncy(3.5,0,t),y))
