...
for (i in 1:10) {
  ...
  filter(
      r >= -x_max(morse(de, beta, i), de, beta, -r0) & r <= x_max(morse(de, beta, i), de, beta, r0)
      )
...
for (i in 1:10) {
df2 = rbind(df2,
            data.frame(r=r, n=i, Potencial="Harm", Energia = potencial(de, beta, r, r0))
            )
}

p = ggplot(df2, aes(x=r, y=Energia, frame=n, colour=Potencial))+
  geom_line()+
  ylim(-200,1000)
