...
\end{align}
Porém podemos ver que $\frac{T_{2x}}{T_{1x}}=\tan\theta$. E pela definição de derivada teremos $\tan\theta = \frac{dy}{dx}$. Assim
\begin{align}
...
\end{align}
Assim podemos perceber que $y(x,t)$ somente satisfaz a equação se $v=\frac{\omega}{k}$, o que é verdade, como foi demonstrado anteriormente.
]
