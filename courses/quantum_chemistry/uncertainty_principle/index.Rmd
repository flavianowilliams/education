...
Neste caso $\Psi$ pode ter partes complexas, com a intenção de representar a incerteza na medição. Portanto, não basta apenas fazer o produto $\Psi^2$, pois <font class="red">devemos multiplicar a função de onda pelo seu complexo conjugado. Isso é necessário, pois precisamos de um valor real para representar a localização do elétron</font>.
